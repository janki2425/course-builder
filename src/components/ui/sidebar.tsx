  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative w-[48px] bg-transparent transition-[width] duration-200 ease-linear",
          "md:w-[220px] md:group-data-[collapsible=icon]:w-[60px]",
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 h-svh w-[48px] transition-[left,right,width] duration-200 ease-linear md:w-[220px] md:group-data-[collapsible=icon]:w-[60px] md:flex",
          side === "left"
